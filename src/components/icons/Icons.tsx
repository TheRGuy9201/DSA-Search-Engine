// Collection of icon components used in the app
...
export const ProblemsetIcon: React.FC = () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const BookmarkIcon: React.FC<{ bookmarked: boolean }> = ({ bookmarked }) => (
    <svg
        className={`w-6 h-6 transition-all duration-300 ${bookmarked ? 'text-indigo-400 fill-current' : 'text-gray-400'}`}
        viewBox="0 0 24 24"
